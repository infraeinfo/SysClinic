...
CREATE TABLE sysclinicdb.consuilta (
...
CREATE TABLE sysclinicdb.localidade (
...
CREATE TABLE sysclinicdb.loguin (
...
CREATE TABLE sysclinicdb.medico (
...
CREATE TABLE sysclinicdb.paciente (
...
ALTER TABLE sysclinicdb.medico ADD CONSTRAINT medico_localidade_fk
FOREIGN KEY (cod_localidade)
REFERENCES sysclinicdb.localidade (cod_localidade)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE sysclinicdb.paciente ADD CONSTRAINT paciente_localidade_fk
FOREIGN KEY (cod_localidade)
REFERENCES sysclinicdb.localidade (cod_localidade)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE sysclinicdb.medico ADD CONSTRAINT loguin_medico_fk
FOREIGN KEY (cod_usuario)
REFERENCES sysclinicdb.loguin (cod_usuario)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE sysclinicdb.paciente ADD CONSTRAINT loguin_paciente_fk
FOREIGN KEY (cod_usuario)
REFERENCES sysclinicdb.loguin (cod_usuario)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE sysclinicdb.consuilta ADD CONSTRAINT medico_consuilta_fk
FOREIGN KEY (cod_medico, cod_usuario)
REFERENCES sysclinicdb.medico (cod_medico, cod_usuario)
ON DELETE NO ACTION
ON UPDATE NO ACTION;

ALTER TABLE sysclinicdb.consuilta ADD CONSTRAINT paciente_consuilta_fk
FOREIGN KEY (cod_usuario, idpaciente)
REFERENCES sysclinicdb.paciente (cod_usuario, idpaciente)
ON DELETE NO ACTION
ON UPDATE NO ACTION;
